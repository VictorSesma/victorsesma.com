...
export const cvEvents = () => {
    let cv = {
        lifeEvent0: {
            ...
            EndDate: "Now",
            Name: "Go Senior Software Engieneer",
            Summary: `Integration and Mantinance of new Clients at Xiatech.co.uk`,
            Description: `- Design, build, maintenance and bug fixing of the client's integrations
            - Tech stack: AWS Lambdas, S3, CloudWatch, Secrets Manager, SNS, DynamoDB, Kinesis and others`,
            ShownOrder: 0
        },
        lifeEvent1: {
